...
const Expenses = ({ classes }) => {
  ...
  return (
    <div className={classes.incomesContainer}>
      ...
      <p className={classes.titleIncomes}>Tus gastos:</p>
